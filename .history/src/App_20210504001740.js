...
import { InitialStateProps } from "../../redux/reducers";
const iconsFolder = require.context("../../resources/icons");
...
function App() {
  ...
  const menuItems = useSelector((state: InitialStateProps) => state.data);
          ...
          {typeof weather.main != "undefined" ? (
            <div>
              ...
              <div>
                ...
                <div>
                    <div className='d-flex align-items-center cursor-pointer' onClick={() => dispatch({ type: 'set_active_category', payload: menu[0] })}>
                        {menu[1].icons?.['gray'] &&
                            <img src={iconsFolder(`./${menu[1].icons}`).default} alt={menu[1].title} className='m-2' style={{ width: '50px', height: '50px' }} />}
