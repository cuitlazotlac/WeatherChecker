...
function App() {
  ...
  const search = (evt, weather_icon) => {
    ...
    console.log("here it goes"+search.weather_icon);
    console.log("here it goes Lol"+weather_icon);
  };
